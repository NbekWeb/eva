...
<template>
  <div
    class="relative flex items-center h-10 pr-1 overflow-x-hidden transition duration-300 pl-7 group hover:bg-blue-600/15 hover:cursor-pointer"
    :class="isDropdownOpen && 'bg-blue-600/15'"
  >
    <div class="flex items-center justify-between gap-2">
      <div class="flex items-center flex- gap-2.5 text-base">
        <IconMsg
        ...
        <p
          ...
          :class="isDropdownOpen && 'text-blue-100'"
        >
          Какие продукты помогут d sa снизитуровень сахара в крови? Какие
